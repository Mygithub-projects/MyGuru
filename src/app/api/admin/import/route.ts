...
import { loadWorkbookFromBuffer, parsePajskWorksheet } from "@/lib/import";
import { jalankanImportGuru, diffPajsk } from "@/lib/import-run";
...
export async function POST(request: NextRequest) {
  ...
  if (!["pajsk", "guru"].includes(jenis)) return fail("Jenis import tidak sah", 422);
